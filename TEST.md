...
<ul>
    ...
    <li>All fields completed but passwords too closely resemble the provided email address - form will not submit.</li>
</ul>
...
<ul>
    ...
    <li>The passwords entered too closely resemble the user's email address - form will not submit.</li>
</ul>
...
### W3C (HTML validation)
<br>
index.html: <img src="media/nu-html-checker-validation-index.png" alt="An image of index.html passing validation.">
menu.html: <img src="media/nu-html-checker-validation-menu.png" alt="An image of .html passing validation.">
menu_item_detail.html (pizza): <img src="media/nu-html-checker-validation-menu-item-detail-pizza.png" alt="An image of .html passing validation.">
menu_item_detail.html (side): <img src="media/nu-html-checker-validation-menu-item-detail-side.png" alt="An image of .html passing validation.">
menu_item_detail.html (with reviews): <img src="media/nu-html-checker-validation-menu-item-detail-reviews.png" alt="An image of .html passing validation.">
cart.html: <img src="media/nu-html-checker-validation-cart.png" alt="An image of .html passing validation.">
checkout.html: <img src="media/nu-html-checker-validation-checkout.png" alt="An image of .html passing validation.">
checkout_success.html: <img src="media/nu-html-checker-validation-checkout-success.png" alt="An image of .html passing validation.">
profile.html: <img src="media/nu-html-checker-validation-profile.png" alt="An image of .html passing validation.">
checkout_success.html (order history): <img src="media/nu-html-checker-validation-checkout-success-order-history.png" alt="An image of .html passing validation.">
contact_us.html: <img src="media/nu-html-checker-validation-contact-us.png" alt="An image of .html passing validation.">
add_menu_item.html (the errors are the result of widget.attrs code in forms.py): <img src="media/nu-html-checker-validation-add-menu-item.png" alt="An image of .html passing validation.">
edit_menu_item.html (the errors are the result of widget.attrs code in forms.py, and it doesn't seem to be possible to fix the lack of alt attributes on the img elements generated by forms.py. View source ignores any changes made with JavaScript): <img src="media/nu-html-checker-validation-edit-menu-item.png" alt="An image of .html passing validation.">
signup.html: <img src="media/nu-html-checker-validation-signup.png" alt="An image of .html passing validation.">
verification_sent.html: <img src="media/nu-html-checker-validation-verification-sent.png" alt="An image of .html passing validation.">
confirm_email.html: <img src="media/nu-html-checker-validation-confirm-email.png" alt="An image of .html passing validation.">
login.html: <img src="media/nu-html-checker-validation-login.png" alt="An image of .html passing validation.">
password_reset.html: <img src="media/nu-html-checker-validation-password-reset.png" alt="An image of .html passing validation.">
password_reset_done.html: <img src="media/nu-html-checker-validation-password-reset-done.png" alt="An image of .html passing validation.">
password_reset_from_key.html: <img src="media/nu-html-checker-validation-password-reset-from-key.png" alt="An image of .html passing validation.">
password_reset_from_key_done.html: <img src="media/nu-html-checker-validation-password-reset-from-key-done.png" alt="An image of .html passing validation.">
logout.html: <img src="media/nu-html-checker-validation-logout.png" alt="An image of .html passing validation.">
<br>
