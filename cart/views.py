...
def add_to_cart(request, item_id):
    ...
    if size:
        ...
        if item_id in list(cart.keys()):
            ...
            messages.success(request, f'Updated {menu_item.name} ' +
    ...
    if size:
        if quantity > 0:
            ...
            messages.success(request, f'Removed size {size.upper()} ' +
                             f'{menu_item.name} from your cart')
    else:
        if quantity > 0:
            cart[item_id] = quantity
            messages.success(request, f'Updated {menu_item.name} ' +
            ...
            cart.pop(item_id)
            messages.success(request, f'Removed {menu_item.name} ' +
                             'from your cart')
